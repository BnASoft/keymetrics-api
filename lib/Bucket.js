...
var DataMethods    = require('./Bucket/Data.js');
var UserMethods    = require('./Bucket/User.js');
var AlertMethods   = require('./Bucket/Alert.js');
var ActionMethods  = require('./Bucket/Action.js');
...
function Bucket(opts) {
  ...
  Object.assign(this, {Data: {}, User: {}, Alert: {}, Action: {} });
  ...
  Object.assign(this.Data, new DataMethods(this));
  Object.assign(this.User, new UserMethods(this));
  Object.assign(this.Alert, new AlertMethods(this));
  Object.assign(this.Action, new ActionMethods(this));
...
Bucket.prototype = {
  ...
  bindEvents: function () {
    ...
    this.bus.on('*:process:exception', function (data) {
